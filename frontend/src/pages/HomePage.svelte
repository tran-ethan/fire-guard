...
<div class="background">
  ...
  <header class="header">
    ...
    <h1 class="header-text" on:click={scrollToPosition}> About </h1>
    <h1 class="header-text"> Collaboration </h1>
  </header>

  <div class="sub">
    <span id="sub1">Guard the Flames,</span><br>
    <span id="sub2">Shield the Future</span>
  </div>
  
  <div class="sub3">
    A machine learning model that analyzes weather patterns, vegetation types, 
    and historical fire records to accurately predict wildfires' likelihood, location, and severity to strategically place fire shelters.
  </div>
...
.header {
  ...
  border-bottom: 0.5px solid #422800; 
